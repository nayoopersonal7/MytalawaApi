...
export const addUserToUserFamily: MutationResolvers["addUserToUserFamily"] =
  async (_parent, args, context) => {
    ...
    const isUserMemberOfUserFamily = !!userFamily.users.find((user) => user.equals(args.userId));
    
    console.log("qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq", isUserMemberOfUserFamily, typeof(userFamily.users[0]), typeof(args.userId));
