...
[src/env.ts:3](https://github.com/PalisadoesFoundation/talawa-api/blob/3677888/api/env.ts#L3)
...
[src/env.ts:36](https://github.com/PalisadoesFoundation/talawa-api/blob/3677888/api/env.ts#L36)
